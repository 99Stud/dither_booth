...
import type {
  NumberFieldName,
  NumberFieldValue,
} from "./internal/NumberField.types";

type NumberFieldProps<
  TFormData,
  TName extends NumberFieldName<TFormData>,
  ...
  return (
    <form.Field
      ...
      children={(field) => {
        ...
        const fieldValue = field.state.value as NumberFieldValue<
          TFormData,
          TName
        >;
        return (
...
export type { NumberFieldName, NumberFieldValue };
